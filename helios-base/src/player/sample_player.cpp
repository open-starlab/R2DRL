...
void SamplePlayer::setActionMask() {
    ...
    const double x_min = -SP.pitchHalfLength() + 0.5;
    const double x_max =  SP.pitchHalfLength() - 0.5;
    const double y_min = -SP.pitchHalfWidth()  + 0.5;
    const double y_max =  SP.pitchHalfWidth()  - 0.5;
