...
def load_env_args(cfg: Any, overrides: Dict[str, Any]) -> Dict[str, Any]:
    ...
    summary_keys = [
        ...
        "use_custom_start", "useMaxEpv", "epv_progress_reward",
        "epv_progress_scale", "epv_grid_file",
        "game_logging", "text_logging",
        "terminate_on_goal", "reward_on_goal_scored", "reward_on_goal_conceded",
        "terminate_on_possession_loss",
        "reward_on_possession_loss", "terminate_on_ball_out",
        "reward_on_ball_out", "terminate_on_ball_left_half",
        "reward_on_ball_left_half", "reward_on_timeout", "reward_on_draw",
        "trajectory_path", "scenario_difficulty",
        "scenario_difficulty_buckets", "start_catalog_enabled", "start_id",
        "start_index", "freeze_non_controlled", "active_right_unums",
        "use_action_mask",
    ]
    summary = ", ".join(
