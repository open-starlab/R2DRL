...
class EnvConfig:
    ...
    def __init__(self, args: Dict[str, Any]):
        ...
        self.reward_on_goal_scored: float = self._optional_float(
            args, "reward_on_goal_scored", 1.0
        )
        self.reward_on_goal_conceded: float = self._optional_float(
            args, "reward_on_goal_conceded", -1.0
        )
